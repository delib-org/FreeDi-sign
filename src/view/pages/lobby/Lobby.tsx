            ...
            <main>
                <div className="wrapper">
                    ...
                    <header>
                        ...
                        <p>תוכלו להרחיב בנושאים שחשובים בעינכם, לתת הארות שחשוב שצוותי המימוש ייקח בחשבון, לתת רעיונות לחיבורים נוספים או התפתחות נוספת, והכי חשוב- תכירו את התכניות ותהיו שותפים להתפתחות הגולן.</p>
